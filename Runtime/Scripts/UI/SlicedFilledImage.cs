...
#pragma warning disable 0649
        ...
        public float pixelsPerUnitMultiplier
        {
            ...
            set
            {
                ...
                if (SetPropertyUtility.SetStruct(ref m_PixelsPerUnitMultiplier, clamped))
                {
                    SetVerticesDirty();
                    SetLayoutDirty();
                }
...
#pragma warning restore 1692
        ...
        private void GenerateSlicedFilledSprite(VertexHelper vh)
        {
            ...
            var border = GetAdjustedBorders(sprite.border / pixelsPerUnit, rect);
            ...
            if (m_PreserveBorder)
                switch (m_FillDirection)
                {
                    case FillDirection.Right:
                    {
                        ...
                        var width = s_SlicedVertices[3].x - s_SlicedVertices[0].x;
                    ...
                    case FillDirection.Up:
                    {
                        ...
                        var height = s_SlicedVertices[3].y - s_SlicedVertices[0].y;
            ...
            for (var x = 0; x < 3; x++)
            {
                ...
                for (var y = 0; y < 3; y++)
                {
                    ...
                    var fillAmount = (m_FillAmount - sliceStart) / sliceSize;
